/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d399c15fec4beaaed106973f21348b9a)
// Runtime types generated with workerd@1.20260801.1 2026-06-02 nodejs_compat
interface __BaseEnv_Env {
	FILES: R2Bucket;
	DB: D1Database;
	APP_URL: "https://opensession-website-preview.remorses.workers.dev" | "https://opensession.dev";
...
declare namespace Cloudflare {
	interface PreviewEnv {
		FILES: R2Bucket;
		DB: D1Database;
		APP_URL: "https://opensession-website-preview.remorses.workers.dev";
		BETTER_AUTH_SECRET: string;
		BETTER_AUTH_URL: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
