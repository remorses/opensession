// Dialog built on @base-ui/react/dialog, ported from sigillo.
// Auto-closes on client-side navigation.
'use client'
...
export function DialogFooter({
  ...
  render,
  ...props
}: useRender.ComponentProps<'div'> & { variant?: 'default' | 'bare' }): React.ReactElement {
  const defaultProps = {
    className: cn(
