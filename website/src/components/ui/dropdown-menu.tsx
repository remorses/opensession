// Dropdown menu built on @base-ui/react/menu, ported from sigillo.
...
export function DropdownMenuTrigger({ className, ...props }: MenuPrimitive.Trigger.Props): React.ReactElement {
  return (
...
export function DropdownMenuItem({ className, ...props }: MenuPrimitive.Item.Props): React.ReactElement {
  return (
    <MenuPrimitive.Item
      className={cn(
...
export function DropdownMenuLinkItem({ className, ...props }: MenuPrimitive.LinkItem.Props): React.ReactElement {
  return (
...
export function DropdownMenuSeparator({ className }: { className?: string }): React.ReactElement {
  return <div role="separator" className={cn('my-1 h-px bg-border', className)} data-slot="dropdown-menu-separator" />
}

export function DropdownMenuLabel({ className, ...props }: React.ComponentProps<'div'>): React.ReactElement {
  return (
    <div
